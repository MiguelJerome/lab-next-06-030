...
export default function Images() {
    ...
    return <>
        <Head>
            ...
            <meta name="description" content="Page présentant le composant Gallerie qui nous permet d'afficher une liste d'images." />

            <meta property="og:title" content="Laboratoire - Images" />
            <meta property="og:description" content="Page présentant le composant Gallerie qui nous permet d'afficher une liste d'images." />
